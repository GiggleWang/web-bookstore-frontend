...
export const booksData = [
    ...
    {
        "id": 11,
        "title": "吉伊卡哇 這又小又可愛的傢伙 5",
        "author": "nagano",
        "description": "电视动画也大受好评！人气系列“Chikawa”，期待已久的第5卷登场！！ 千鹤他们在森林里遇见的大个子“奥德”。在奥德的推荐下一起吃蘑菇的时候，被地精们抓住了！ 和奥德一起被关在监狱里的千鹤们。这样下去的话会被地精们吃掉的！但是……大家都能不放弃就逃出来吧 除了“奥德”篇，还收录了强烈反响的“老虎机”篇和“黑色流星”篇！还有只用单行本才能读懂的画！ 虽然有痛苦和悲伤，但明天也想和蕞喜欢的大家一起笑着生活。找到小小的幸福，小小的日子还在继续！",
        "price": 6600,
        "cover": "/img/11.jpg",
        "sales": 0
    },
...
function updateUserInfo(index, newUser) {
    userInfo[index] = newUser;
    // 可能还需要触发某种形式的更新，以确保使用了 userInfo 的组件能够重新渲染
}
